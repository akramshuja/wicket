...
public class UploadToResourcePage extends WicketExamplePage
{
	...
	public UploadToResourcePage(final PageParameters parameters)
	{
		...
		fileUploadToResourceField.setMaxSize(Bytes.megabytes(100));
		fileUploadToResourceField.setFileMaxSize(Bytes.megabytes(10));
		fileUploadToResourceField.setFileCountMax(5);
